...
<p><strong>Correctly applied access control rules are </strong> key to keeping your data secure</a>.
Almost all applications need to protect sensitive data and operations, so putting careful thought into how to restrict access is important when designing a system.</p>
...
<p><strong>Depending on the sensitivity of the data that your application handles, the repercussions of broken access control can be very severe. Data leaks can cause reputational damage, cost your business financial penalties, make your customers vulnerable to fraud, and even endanger national security (if you work for a government agency).</strong></p>





<p><strong>How to Protect from Broken Access Control</strong> </p>
<p>1.Authentication - correctly identifying a user when they return to the application.</p>
<p>2.Authorization - deciding what actions a user should and should not be able to perform once they have been authenticated.</p>
<p>3.Permission Checking - evaluating authorization at the point-in-time when a user attempts to perform an action.</p>
<p>4.Test access control critically. Make sure your testing procedures genuinely attempt to find holes in your access control scheme. Treat it like an attacker would, and you will be better prepared when your first real attack occurs. If you have the time and budget, consider employing an external team to perform penetration testing.</p>
