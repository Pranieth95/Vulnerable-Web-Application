...
<p><strong>Reflected</strong>Xss</a>.
...
<p><strong>How to Protect from Reflected XSS Attacks?</strong> </p>
<p>1.Be sure to check all pages on your site, whether they write to the data store or not!</p>
<p>2.Whitelist Values - If a particular dynamic data item can only take a handful of valid values, the best practice is to restrict the values in the data store, and have your rendering logic only permit known good values. If a URL expects a “country” parameter in the URL, for instance, make sure it is only permitted to take on one of a list of valid enumerated values.</p>
