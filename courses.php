			...
			<div class="row course_boxes">
				...
				<div class="col-lg-4 course_box">
					<div class="card">
						...
						<div class="card-body text-center">
							<div class="card-title"><a href="courses.html">Information Technology</a></div>
						...
						<div class="price_box d-flex flex-row align-items-center">
							...
							<div class="course_price d-flex flex-column align-items-center justify-content-center"><span>4 Yrs</span></div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 course_box">
					<div class="card">
						...
						<div class="card-body text-center">
							<div class="card-title"><a href="courses.html">Software Engineering</a></div>
							<div class="card-text">Adobe Guide, Layes, Smart Objects etc...</div>
						</div>
						<div class="price_box d-flex flex-row align-items-center">
							<div class="course_author_image">
				...
				<div class="col-lg-4 course_box">
					<div class="card">
						...
						<div class="card-body text-center">
							<div class="card-title"><a href="courses.html">Industrial Mathematics</a></div>
							<div class="card-text">Adobe Guide, Layes, Smart Objects etc...</div>
						</div>
						<div class="price_box d-flex flex-row align-items-center">
							<div class="course_author_image">
				...
				<div class="col-lg-4 course_box">
					<div class="card">
						...
						<div class="card-body text-center">
							<div class="card-title"><a href="courses.html">Data Science</a></div>
							<div class="card-text">Adobe Guide, Layes, Smart Objects etc...</div>
						</div>
						<div class="price_box d-flex flex-row align-items-center">
							<div class="course_author_image">
				...
				<div class="col-lg-4 course_box">
					<div class="card">
						...
						<div class="card-body text-center">
							<div class="card-title"><a href="courses.html">Secure Software Systems</a></div>
							<div class="card-text">Adobe Guide, Layes, Smart Objects etc...</div>
						</div>
						<div class="price_box d-flex flex-row align-items-center">
							<div class="course_author_image">
				...
				<div class="col-lg-4 course_box">
					<div class="card">
						...
						<div class="card-body text-center">
							<div class="card-title"><a href="courses.html">Cryptography</a></div>
							<div class="card-text">Adobe Guide, Layes, Smart Objects etc...</div>
						</div>
						<div class="price_box d-flex flex-row align-items-center">
							<div class="course_author_image">
				...
				<div class="col-lg-4 course_box">
					<div class="card">
						...
						<div class="card-body text-center">
							<div class="card-title"><a href="courses.html">Project Management</a></div>
							<div class="card-text">Adobe Guide, Layes, Smart Objects etc...</div>
						</div>
						<div class="price_box d-flex flex-row align-items-center">
							<div class="course_author_image">
							...
							<div class="course_author_name">Michael Smith, <span>Author</span></div>
							<div class="course_price d-flex flex-column align-items-center justify-content-center"><span>3 Yrs</span></div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 course_box">
					<div class="card">
						...
						<div class="card-body text-center">
							<div class="card-title"><a href="courses.php">Internet Technology PRotocol</a></div>
							<div class="card-text">Adobe Guide, Layes, Smart Objects etc...</div>
						</div>
						<div class="price_box d-flex flex-row align-items-center">
							<div class="course_author_image">
