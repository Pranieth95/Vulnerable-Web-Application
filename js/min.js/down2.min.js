var limit = 10;
if(localStorage.getItem("ch2-counter")){
	if(localStorage.getItem("ch2-counter") == "Done"){
		var value = limit;
		loadHint_Login();
	}else{
		var value = localStorage.getItem("ch2-counter");
	}
	}else{
		var value = 0;
	}
...
if(value != NaN){
	if(value >= limit){
	  localStorage.setItem("ch2-counter", "Done");
	  timesRun += 1;
	}else{
	  value = parseInt(value)+1;
	  localStorage.setItem("ch2-counter", value);
	}
	var rem = limit - value;
